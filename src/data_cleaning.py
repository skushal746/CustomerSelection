...
class DataPreProcessStrategy(DataStrategy):
    ...
    def handle_data(self, data:pd.DataFrame) -> pd.DataFrame:
        """
        Preprocess Data
        Deleting some columns to make the project simple at the moment
        """
        try:
            data=data.drop ([
                    "oder_approval_at", 
            ...
            cols_to_drop=["cusotomer_zip_code_prefix", "order_item_id"]
...
class DataDivideStrategy(DataStrategy):
    ...
    def handle_data(self, data:pd.DataFrame) -> Union[pd.DataFramne, pd.Series]:
        """
